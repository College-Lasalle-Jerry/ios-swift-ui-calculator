            ...
            HStack {
                RoundedRectangle(cornerRadius: 15)
                    ...
                    .onAppear(perform: {
                        // run this code
                        //                    self.blur = 20
                        self.changeColor.toggle() // if true make it false and vice versa.
                    })
                    .overlay(
                        Text(value)
                ...
                HStack(spacing: 12){
                    ForEach(row, id: \.self){
                        ...
                        Button(action: {
                            ...
                            //                               // do not use corner radiurs property, it is depricated, use clipshape(RoundedRectangle(cornerRadius: 30)) instead.
